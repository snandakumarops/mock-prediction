// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent19
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent19#deploy_0
    RETURN
    ** label2
